...
# Form implementation generated from reading ui file '/home/bb/work/probe_basic-pyqt5-x86-dev/sources/debian/python3-probe-basic/usr/share/configs/rack_atc_sim/user_dro_display/user_dros/offset_dros_user.ui'
#
...
"}")
        ...
        self.axis_label_c = QtWidgets.QLabel(offset_dros_xyzab)
...
"]"))
        ...
        self.g52_g92_y.setProperty("rules", _translate("offset_dros_xyzab", "[{\"channels\": [{\"trigger\": true, \"type\": \"tuple\", \"url\": \"status:g92_offset\"}], \"property\": \"Text\", \"expression\": \"\\\"{:.4f}\\\".format(ch[0][1])\", \"name\": \"New Rule\"}]"))
        self.tool_offset_y.setProperty("rules", _translate("offset_dros_xyzab", "[{\"channels\": [{\"trigger\": true, \"type\": \"tuple\", \"url\": \"status:tool_offset\"}], \"property\": \"Text\", \"expression\": \"\\\"{:.4f}\\\".format(ch[0][1])\", \"name\": \"New Rule\"}]"))
...
"]"))
        ...
        self.zero_c_button.setText(_translate("offset_dros_xyzab", "ZERO"))
        self.zero_c_button.setProperty("rules", _translate("offset_dros_xyzab", "[\n"
"    {\n"
"        \"channels\": [\n"
"            {\n"
"                \"url\": \"status:g5x_index\",\n"
...
"    }\n"
"]"))
        self.zero_c_button.setProperty("MDICommand", _translate("offset_dros_xyzab", "G10 L20 P{ch[0]} C0.0"))
        self.axis_label_c.setText(_translate("offset_dros_xyzab", "C"))
        self.dro_entry_offset_c.setProperty("inchFormat", _translate("offset_dros_xyzab", "%9.4f"))
        self.dro_entry_offset_c.setProperty("millimeterFormat", _translate("offset_dros_xyzab", "%10.3f"))
        self.dro_entry_offset_c.setProperty("degreeFormat", _translate("offset_dros_xyzab", "%10.2f"))
